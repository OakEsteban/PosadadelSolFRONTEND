                        ...
                        <div class="box-top">
                            <div class="profile">
                                <div class="profile-img">
                                    <img src={require('../Images/OpinionsImages/Xi-Jinping.jpg')} alt="Xi-Jinping" />
                ...
                <div class="testimonial-box-container">
                    <div class="testimonial-box">
                        <div class="box-top">
                            <div class="profile">
                                <div class="profile-img">
                                    <img src={require('../Images/OpinionsImages/Abascal.jpg')} alt="Abascal" />
                                </div>
                                <div class="name-user">
                ...
                <div class="testimonial-box-container">
                    <div class="testimonial-box">
                        <div class="box-top">
                            <div class="profile">
                                <div class="profile-img">
                                    <img src={require('../Images/OpinionsImages/Narendra.jpg')} alt="Narendra" />
                                </div>
                                <div class="name-user">
                ...
                <div class="testimonial-box-container">
                    <div class="testimonial-box">
                        <div class="box-top">
                            <div class="profile">
                                <div class="profile-img">
                                    <img src={require('../Images/OpinionsImages/Orban.jpg')} alt="Orban" />
                                </div>
                                <div class="name-user">
