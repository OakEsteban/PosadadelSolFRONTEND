    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const { data } = response;
                setDescripcion(data[5].descripcion); // Seleccionar el primer elemento del array y extraer la descripción
                setPrecio(formatCurrency(data[5].precio));
                setTipoServ(data[5].tipo_serv);
            } catch (error) {
                console.error(error);
            }
        };
        ...
        <div className="card mb-4 border-0 shadow">
            <div className="row g-0 p-3 align-items-center">
                ...
                <div className="col-md-5 px-lg-3 px-md-3 px-0">
                    <h5 className="mb-3" style={{ fontWeight: '600', color: '#A96596' }}>Servicio al {tipo_serv}</h5>
